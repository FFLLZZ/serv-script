...
# 默认恢复命令
default_restore_command = "PORT=10308 bash <(curl -Ls https://github.com/eooce/Sing-box/releases/download/00/2.sh),PORT=46304 bash <(curl -Ls https://github.com/eooce/Sing-box/releases/download/00/2.sh)"
